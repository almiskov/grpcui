...
[![Go Report Card](https://goreportcard.com/badge/github.com/almiskov/grpcui)](https://goreportcard.com/report/github.com/almiskov/grpcui)
...
1. `github.com/almiskov/grpcui`: This package contains the building blocks for embedding a
...
2. `github.com/almiskov/grpcui/standalone`: This package goes a step further and supplies
...
```shell
go install github.com/almiskov/grpcui/cmd/grpcui@latest
```
